...
function renderUtilitySections() {
  ...
  const cards = navLinks
    .map((link) => {
      ...
      const method = section?.querySelector(".method")?.textContent.trim() || "DOC";
  ...
  content.insertAdjacentHTML(
    ...
    `<section class="utility-section" id="api-explorer">
      <h1>API Explorer</h1>
      <p>Use this compact endpoint index to jump directly into the MAE documentation sections.</p>
    ...
    <section class="utility-section" id="changelog">
      ...
      <ol class="changelog-list">
        ...
        <li><strong>MAE migration</strong><span>Recreated the public MAE API documentation as a static GitHub Pages site.</span></li>
      </ol>
    </section>`
  );
}
